...
export class ExtensionesServicio {
  ...
  @ApiProperty({ description: 'Horas Agregadas', example: '1200.00' })
  ...
  @ApiProperty({ description: 'Aceptada Por', enum: ['cliente', 'empleada'], example: 'cliente' })
  ...
  @ApiProperty({ description: 'Registrada At', type: String, format: 'date-time', example: '2026-07-09T12:00:00.000Z' })
  registradaAt: Date;
