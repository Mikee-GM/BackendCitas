...
export class ClientMembership {
  ...
  @ApiProperty({ description: 'Tier Id', example: '00000000-0000-4000-8000-000000000000' })
  tierId: string;
  ...
  @ApiProperty({ description: 'Status', enum: ['active', 'inactive', 'suspended'], example: 'active' })
  ...
  @ApiProperty({ description: 'Assignment Type', enum: ['automatic', 'manual'], example: 'automatic' })
  ...
  @ApiPropertyOptional({ description: 'Assigned By User Id', example: '00000000-0000-4000-8000-000000000000' })
  ...
  @ApiProperty({ description: 'Joined At', type: String, format: 'date-time', example: '2026-07-09T12:00:00.000Z' })
  joinedAt: Date;

  @Column('timestamp with time zone', { name: 'assigned_at', nullable: true })
  @ApiPropertyOptional({ description: 'Assigned At', type: String, format: 'date-time', example: '2026-07-09T12:00:00.000Z' })
