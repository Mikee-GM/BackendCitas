...
export class CreateEmployeeDto {
  @ApiProperty({ description: 'Correo electronico de la empleada', example: 'empleada@example.com', maxLength: 255 })
  ...
  @ApiProperty({ description: 'Contrasena inicial de la empleada', example: 'secret123', minLength: 6 })
  ...
  @ApiProperty({ description: 'Nombre real de la empleada', example: 'Ana Garcia', maxLength: 255 })
  ...
  @ApiProperty({ description: 'Nombre artistico mostrado en catalogo', example: 'Anita', maxLength: 255 })
  ...
  @ApiProperty({ description: 'Slug unico para el catalogo publico', example: 'anita', maxLength: 100 })
  ...
  @ApiPropertyOptional({ description: 'URL de la foto principal de perfil', example: 'https://example.com/perfil.jpg' })
  @IsString({
  ...
  @ApiPropertyOptional({ description: 'Descripcion publica o interna de la empleada', example: 'Disponible para servicios en zona centro.' })
  ...
  @ApiPropertyOptional({ description: 'Indica si la empleada esta disponible', example: true, default: true })
  @IsBoolean({ message: 'El estado disponible debe ser un valor booleano' })
  @IsOptional()
  readonly disponible?: boolean;

  @ApiPropertyOptional({ description: 'Indica si aparece activa en catalogo', example: true, default: true })
  @IsBoolean({
  ...
  @ApiPropertyOptional({ description: 'Latitud actual o registrada', example: '19.432608' })
  @IsString({ message: 'La latitud debe ser una cadena de texto' })
  @IsOptional()
  readonly ubicacionLat?: string;

  @ApiPropertyOptional({ description: 'Longitud actual o registrada', example: '-99.133209' })
  @IsString({ message: 'La longitud debe ser una cadena de texto' })
  @IsOptional()
  readonly ubicacionLng?: string;

  @ApiPropertyOptional({ description: 'ID del jefe asignado', example: '00000000-0000-4000-8000-000000000000', format: 'uuid' })
  @IsString({ message: 'El ID del jefe debe ser una cadena de texto' })
  @IsOptional()
  readonly jefeId?: string;

  @ApiPropertyOptional({ description: 'URLs de fotos adicionales', example: ['https://example.com/foto-1.jpg'], type: [String] })
  ...
  @ApiProperty({ description: 'Tipo operativo de la empleada', enum: ['independiente', 'agencia'], example: 'independiente' })
