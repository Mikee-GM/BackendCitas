...
export class InitialSchema1782424709580 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "empleada_fotos" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "empleada_id" uuid NOT NULL, "url" text NOT NULL, "orden" smallint NOT NULL DEFAULT 0, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_1fb684931383502b5e8cb80f4fc" UNIQUE ("empleada_id"), CONSTRAINT "UQ_945badb9651262887956008e173" UNIQUE ("orden"), CONSTRAINT "PK_a67e10f6dade74044877b36c056" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."extras_servicio_metodo_pago_enum" AS ENUM('tarjeta', 'transferencia')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."servicios_estado_enum" AS ENUM('pendiente', 'en_curso', 'finalizado', 'cancelado')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "extras_catalogo_empleada_id_nombre_key" ON "extras_catalogo"  ("empleada_id", "nombre") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."extras_catalogo_empleada_id_nombre_key"`,
    );
