...
export class CreateEmployeePhotoDto {
  @ApiProperty({ description: 'ID de la empleada propietaria de la foto', example: '00000000-0000-4000-8000-000000000000', format: 'uuid' })
  ...
  @ApiProperty({ description: 'URL publica de la foto', example: 'https://example.com/foto.jpg' })
  @IsString({ message: 'La URL debe ser una cadena de texto' })
  @IsNotEmpty({ message: 'La URL es obligatoria' })
  readonly url: string;

  @ApiPropertyOptional({ description: 'Orden de aparicion en galeria', example: 1 })
